...
.\node_modules\.bin\processmd "temp/portfolio/**/*.{yml,md}" --stdout --outputDir temp/portfoliooutput/allportfolio > allportfolio.json
Write-Host "Generated complete portfolio JSON..."

.\node_modules\.bin\processmd "temp/portfolio/projects/**/*.{yml,md}" --stdout --outputDir temp/portfoliooutput/allprojects > allprojects.json
Write-Host "Generated only projects JSON..."

.\node_modules\.bin\processmd "temp/portfolio/speaking/**/*.{yml,md}" --stdout --outputDir temp/portfoliooutput/allspeaking > allspeaking.json
Write-Host "Generated only speaking JSON..."

.\node_modules\.bin\processmd "temp/portfolio/teaching/**/*.{yml,md}" --stdout --outputDir temp/portfoliooutput/allteaching > allteaching.json
Write-Host "Generated only teaching JSON..."

.\node_modules\.bin\processmd "temp/portfolio/books/**/*.{yml,md}" --stdout --outputDir temp/portfoliooutput/allbooks > allbooks.json
Write-Host "Generated only books JSON..."

.\node_modules\.bin\processmd "temp/portfolio/highlights/**/*.{yml,md}" --stdout --outputDir temp/portfoliooutput/allhighlights > allhighlights.json
...
.\node_modules\.bin\processmd "temp/pinneditems/**/*.{yml,md}" --stdout --outputDir temp/portfoliooutput/allpinned > allpinned.json
...
ForEach ($projectYear in $projectYears) { 
  ...
  $inputDirectory = "temp/portfolio/projects/"+$projectYear+"/**/*.{yml,md}"
